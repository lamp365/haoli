...
class process extends \common\controller\basecontroller
{
    public function index()
    {
        ...
        if (strtolower($_SERVER['REQUEST_METHOD']) == 'post') {
            ...
            if ($message['type'] == 'subscribe') {
                //$eventkey  带场景值  用于活动中绑定用户关系  此次活动中 eventkey 就是商户openid
                ...
                //设置分享者信息的缓存  用于注册的时候获取推荐人
                $message['openid'] = $eventkey;
                set_scan_cache($message);
