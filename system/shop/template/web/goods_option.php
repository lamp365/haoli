...
.option_stock_all{
	...
	<div class="form-group">
										...
										<div class="col-sm-9">
    	 <input type="checkbox" id="hasoption" value="1" name="hasoption" <?php if($item['hasoption']==1){?>checked<?php } ?> onchange="iFrame()"/>
...
<div id='tboption' class="form-group" style='overflow:hidden;<?php if( $item['hasoption']!=1){?>display:none<?php } ?>'>
	
	<div class="form-group">
  	<label class="col-sm-2 control-label no-padding-left" >&nbsp;</label>
										<div class="col-sm-9">
 <a href="javascript:;" class='btn btn-primary' id='add-spec' onclick="addSpec();iFrame();" style="margin-top:10px;margin-bottom:10px;"  title="添加规格"><i class="icon-plus"></i>添加规格</a> 
        </div>
</div>
