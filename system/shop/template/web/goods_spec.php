<?php defined('SYSTEM_IN') or exit('Access Denied');?> <div class="spec_item" id='spec_<?php  echo $spec['id'];?>' >
            ...
            <table  class="table">
                ...
                <tr>
                    <td></td>
                    <td><a href="javascript:;" id="add-specitem-<?php  echo $spec['id'];?>" specid='<?php  echo $spec['id'];?>' class='btn add-specitem' onclick="addSpecItem('<?php  echo $spec['id'];?>');iFrame();"> 添加规格项</a>
                        <a href="javascript:void(0);" class='btn btn-danger' onclick="removeSpec('<?php  echo $spec['id'];?>');iFrame();"> 删除规格</a>
                    </td>
                </tr>
