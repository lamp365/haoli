        ...
        <div class="well form-search">
            ...
            <form action="<?php echo web_url('config', array('op' => 'otherSet'))?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="mb10">
                       ...
                       <div class="form-group">
                            <div class="col-sm-2  control-label no-padding-left" >提现费率：</div>
                            <div class="col-sm-3">
                                <input name="teller_rate" class="set_4 form-control" type="text" value="<?php echo $sett['teller_rate']?>">
                            </div>
                        </div>

                       <div class="form-group">
                            <div class="col-sm-2  control-label no-padding-left" >技术提成：</div>
                            <div class="col-sm-3">
                                <input name="jishu_rate" class="set_4 form-control" type="text" value="<?php echo $sett['jishu_rate']?>">
                            </div>
                        </div>
