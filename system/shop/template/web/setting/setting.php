...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-left" >平台公告</label>

		<div class="col-sm-4">
			<textarea name="shop_gongao"  cols="60" rows="8" class="form-control"><?php  echo $settings['shop_gongao'];?></textarea>
		</div>
	</div>
	<div class="form-group">
