...
$package = array();
$package['appid'] = $settings['weixin_appId']='wx861567a3f4af24a2';
...
if (strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger')) {
    ...
    if (empty($code_url)) {
        message("无法发起二维码支付，请更换另外2一种付款方式，或者联系管理员");
    }
    ?>
...
<meta content="telephone=no, address=no" name="format-detection">
	<script type="text/javascript"
		src="<?php echo RESOURCE_ROOT;?>addons/common/js/jquery-1.10.2.min.js"></script>
	<meta name="viewport"
	...
	<title>微信支付</title>
	<link
		href="<?php echo RESOURCE_ROOT;?>addons/modules/payment/weixin/main.css"
		rel="stylesheet" />
	...
	<div class="p-header">
		<div class="w">
			<div id="logo">
                    ...
                    <img  height="40" src="<?php echo $settings['shop_logo'] ?>">
                    <?php } ?>
		...
		<div class="w">
			...
			<div class="order">
				<div class="o-left">
					...
					<p class="o-tips">请您在提交订单后尽快完成支付。</p>
				</div>
				<div class="o-right">
					<div class="o-price">
			...
			<div class="payment">
				...
				<div class="pay-weixin">
					...
					<div class="p-w-bd">
						<div class="p-w-box">
							<div class="pw-box-hd">
								<img alt="模式二扫码支付"
									src="<?php echo WEBSITE_ROOT;?>includes/lib/phpqrcode/qrcode.php?data=<?php echo urlencode($code_url);?>"
				...
				<div class="payment-change">
					...
					</a> <a class="pc-wrap" style="float: right" href="<?php echo mobile_url('myorder',array('name'=>'shopwap'));?>">
