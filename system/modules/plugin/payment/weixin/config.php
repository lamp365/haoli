...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
      <div class="form-group">
										...
										<div class="col-sm-9">
													微信支付&nbsp;&nbsp;<a target="_blank" href="http://www.squdian.com">配置帮助</a>
		 ...
		 <div class="form-group">
				 ...
				 <div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" name="weixin_pay_mchId" class='form-control'  value="<?php  echo $configs['weixin_pay_mchId'];?>" />
										</div>
									</div>
										...
										<div class="col-sm-3">
											 <input type="text" name="weixin_pay_paySignKey" class="form-control" value="<?php  echo $configs['weixin_pay_paySignKey'];?>" />
										</div>
									</div>
