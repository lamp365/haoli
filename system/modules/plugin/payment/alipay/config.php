...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
      <div class="form-group">
										...
										<div class="col-sm-9">
													支付宝&nbsp;&nbsp;<a href="http://www.squdian.com" target="_blank" style="font-size:18px"><strong>配置帮助</strong></a>
										</div>
									</div>
		 ...
		 <div class="form-group">
										...
										<div class="col-sm-3">
											  <input type="text" name="alipay_safekey" class="form-control" value="<?php  echo $configs['alipay_safekey'];?>" />
										</div>
									</div>
		 <div class="form-group">
										...
										<div class="col-sm-3">
											  <input type="text" name="alipay_safepid" class="form-control" value="<?php  echo $configs['alipay_safepid'];?>" />
										</div>
									</div>
				 ...
				 <div class="form-group">
										...
										<div class="col-sm-3">
											<select name="alipay_paytype" id="alipay_paytype" class="form-control"><option value="0" selected="">使用标准双接口</option><option value="1">使用担保交易接口</option><option value="2">使用即时到帐交易接口</option></select>
									<script>
