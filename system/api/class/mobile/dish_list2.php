<?php
	...
	$sql = "SELECT SQL_CALC_FOUND_ROWS d.id,d.title,d.app_marketprice,d.timeprice,d.type,d.timestart,d.timeend,d.commision,g.thumb,b.id as brand_id,c.name as country_name,c.icon as country_icon,ca.name as category_name FROM " . table('shop_dish');
	...
	{
		$sql.= " and g.brand in(".implode(",", json_decode($_REQUEST['brand_id'], true)).") ";
	}

	if(isset($_REQUEST['country_id']))
	{
		$sql.= " and b.country_id in(".implode(",", json_decode($_REQUEST['country_id'], true)).") ";
	}
