		...
		<?php  } ?>
		 <div class="form-group">
		   ...
		   <div class="form-group">
	              ...
	              <div class="form-group">
									<label class="col-sm-2 control-label no-padding-left" > 分类属性</label>
									<div class="col-sm-9">		
									    <input type="radio" name="state" value="1" <?php  if($category['state'] == 1) { ?> checked<?php  } ?> />底部显示
										<input type="radio" name="state" value="2" <?php  if($category['state'] == 2) { ?> checked<?php  } ?> />主题板块
										<input type="radio" name="state" value="3" <?php  if($category['state'] == 3) { ?> checked<?php  } ?> />评论晒图
									</div>
									</div>
			   <div class="form-group">
